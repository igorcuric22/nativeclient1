...
const Cir8 = ({ width = 400, height = 400, pathColor = 'blue', pointColor = 'red', lineColor = 'green' }) => {
  ...
  return (
    <View style={styles.container}>
      <Canvas style={{ width, height }}>
        ...
        <Circle cx={centerX + point2.x} cy={centerY + point2.y} r={radius2} style="stroke" color="black" />
